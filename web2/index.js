...
const dataframeDemo = async () => {
  ...
  // label("DataFrame from CSV", "dfTime" + 1);
  // plotDataframe(df.columns(), df.toArrays, "dataframe" + 1);
...
const seriesDemo = () => {
  ...
  console.log("SeriesI32 with new Element");
  let snwe = SeriesI32.newWithElement("Hello", 4, 0, 4);
  console.log(snwe.display);

  console.log("SeriesI32 with new With Function");
